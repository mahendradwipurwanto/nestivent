<!-- Hero Section -->
<div class="bg-img-hero" style="background-image: url(<?= base_url();?>assets/Nestivent.orgend/svg/components/abstract-shapes-12.svg);">
  <div class="container space-top-3 space-top-lg-4 space-bottom-2 position-relative z-index-2">
    <div class="w-md-80 w-lg-60 text-center mx-md-auto">
      <h1>Nestivent.org Terms &amp; Conditions</h1>
  ...
  <div class="row">
    ...
    <div class="col-md-8 col-lg-9">
      <div id="intro" class="space-bottom-1">
        <!-- Title -->
        <div class="mb-3">
          <h2 class="h3">Welcome to Nestivent.org</h2>
        </div>
        <!-- End Title -->

        <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Nestivent.org"), located at Kota Malang, Jawa Timur - Indonesia.
      ...
      <div id="services" class="space-bottom-1">
        ...
        <ul>
          <li class="pb-2">When you register for a Nestivent.org account we collect your full name, email address, and account log-in credentials.</li>
          ...
          <li class="pb-2">When you use the "Remember Me" feature of Nestivent.org Checkout, we collect your email address, payment card number, CVC code and expiration date.</li>
        </ul>

        <p>When you respond to Nestivent.org emails or surveys we collect your email address, name and any other information you choose to include in the body of your email or responses. If you contact us by phone, we will collect the phone number you use to call Nestivent.org. If you contact us by phone as a Nestivent.org User, we may collect additional information in order to verify your identity.</p>
      ...
      <div id="privacy" class="space-bottom-1">
        ...
        <p>Nestivent.org's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that Nestivent.org can use such data in accordance with our privacy policies.</p>
        ...
        <p>We provide information to help copyright holders manage their intellectual property online. If you think somebody is violating your copyrights and want to notify us, you can find information about submitting notices and Nestivent.org's policy about responding.</p>
      </div>
      ...
      <div id="yourContent">
        ...
        <p>When you upload, submit, store, send or receive content to or through our Services, you give Nestivent.org (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to Nestivent.org Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
      </div>
