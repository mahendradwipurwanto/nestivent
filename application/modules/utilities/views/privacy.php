    ...
    <div class="card">
      ...
      <div class="card-body p-4 p-md-9">
        <div class="mb-7">
          ...
          <!-- Text -->
          <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Nestivent.org"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
