...
<div class="container space-2 space-lg-3">
  ...
  <div class="row mx-n2 mb-5">
    <div class="col-sm-6 col-lg-3 px-2 mb-3">
      ...
      <div class="card h-100 transition-3d-hover">
        <div class="card-body">
          ...
          <h4 class="text-lh-sm">Mahendra Dwi Purwanto</h4>
      ...
      <div class="col-sm-6 col-lg-3 px-2 mb-3">
        ...
        <div class="card h-100 transition-3d-hover">
          <div class="card-body">
            ...
            <span class="d-block small font-weight-bold text-cap mb-1">CFO</span>
            <h4 class="text-lh-sm">-</h4>
        ...
        <div class="col-sm-6 col-lg-3 px-2 mb-3">
          ...
          <div class="card h-100 transition-3d-hover">
            <div class="card-body">
              ...
              <span class="d-block small font-weight-bold text-cap mb-1">CTO</span>
              <h4 class="text-lh-sm">-</h4>
              <p class="font-size-1">-.</p>
            </div>
    ...
    <div class="col-sm-6 col-lg-3 px-2 mb-3">
      ...
      <div class="card h-100 transition-3d-hover">
        ...
        <div class="card-footer border-0 pt-0">
          <a class="btn btn-xs btn-soft-secondary" href="<?= site_url('careers') ?>">View Open Jobs</a>
        </div>
      </div>
      <!-- End Team -->
    </div>
  ...
  <div class="text-center">
    <div class="d-inline-block font-size-1 border bg-white text-center rounded-pill py-3 px-4">
      Wanna work with us? <a class="font-weight-bold ml-3" href="<?= site_url('careers') ?>">We are hiring <span class="fas fa-angle-right fa-sm ml-1"></span></a>
    </div>
  </div>
  <!-- End Info -->
</div>
