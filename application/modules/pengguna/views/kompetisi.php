	...
	<div class="card-body">
		...
		<?php if($kompetisiDiikuti == FALSE): ?>
			<div class="text-center space-1">
				...
				<p class="card-text">Belum ada kompetisi yang diikuti</p>
			</div>
			<!-- End Empty State -->
			<?php else: ?>
				...
				<ul class="list-group mb-5">
					...
					<?php foreach ($kompetisiDiikuti as $key): ?>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="col-sm-auto">
										<a class="btn btn-xs btn-white mr-2" href="<?= site_url('detail-daftar-kompetisi/'.$key->KODE_PENDAFTARAN);?>"><i class="fas fa-pencil-alt mr-1"></i> data pendaftaranmu</a>
									</div>
									<!-- End Row -->
								</div>
							</div>
