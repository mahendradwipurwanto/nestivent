  ...
  <?php if ($aktivasi->STATUS == 0) : ?>
    ...
    <?php elseif ($kPanel == FALSE AND $alert_kpanel == TRUE): ?>
      <?php if ($pending_kpanel == TRUE) : ?>
        <!-- Alert -->
        <div class="alert alert-soft-info rounded-0 mb-0" role="alert">
          Permintaan akses K-Panel anda sedang diproses, <a class="alert-link" href="<?= site_url('pengajuan/penyelenggara') ?>">cek laman k-panel</a>?
          <small class="text-muted text-right pull-right float-right" style="margin-top: 10px !important"><a href="<?= site_url('pengguna/jangan_tampilkan/ALERT_MakeK_PANEL') ?>" class="text-muted">jangan tampilkan</a></small>
        </div>
        <!-- End Alert -->
        <?php else: ?>
          <!-- Alert -->
          <div class="alert alert-soft-info rounded-0 mb-0" role="alert">
            Anda tidak memiliki akses K-Panel untuk membuat kegiatan, <a class="alert-link" href="<?= site_url('pengajuan/penyelenggara') ?>">buat sekarang</a>?
            <small class="text-muted text-right pull-right float-right" style="margin-top: 10px !important"><a href="<?= site_url('pengguna/jangan_tampilkan/ALERT_MakeK_PANEL') ?>" class="text-muted">jangan tampilkan</a></small>
          </div>
          <!-- End Alert -->
        <?php endif;?>
            ...
            <div class="card-body">
              ...
              <div class="media d-block d-sm-flex">
                ...
                <div class="media-body">
                  ...
                  <p class="font-size-1 text-body mb-0"><?= $daftarKompetisi;?> kompetisi <?= $CI->agent->is_mobile() ? '' : 'diikuti';?></p>
                </div>
              </div>
              <!-- End Icon Block -->
            </div>
            ...
            <div class="card-body">
              ...
              <div class="media d-block d-sm-flex">
                ...
                <div class="media-body">
                  ...
                  <p class="font-size-1 text-body mb-0"><?= $daftarEvent;?> Event <?= $CI->agent->is_mobile() ? '' : 'diikuti';?></p>
                </div>
              </div>
              <!-- End Icon Block -->
            </div>
                      ...
                      <tr>
                        <td>
                          <div class="media align-items-center">
                            ...
                            <div class="media-body">
                              <a class="d-inline-block text-dark" href="<?= site_url($key->kegiatan == "kegiatan" ? 'event/'.$key->KODE : 'kompetisi/'.$key->KODE);?>">
                        ...
                        <td>
                          <span class="badge badge-soft-<?= ($key->kegiatan == "kegiatan" ? 'primary' : 'warning');?> badge-pill"><?= ($key->kegiatan == "kegiatan" ? 'event' : 'kompetisi');?></span>
                        </td>
                      </tr>
                    <?php endforeach;?>
                  <?php endif;?>
                      ...
                      <div class="col-12">
                        <div class="media align-items-center">
                          <div class="media-body">
                            ...
                            <small class="d-block text-muted"><span class="text-dark"><?= $CI->M_pengguna->get_sender($key->SENDER) ?></span> <?= $key->MESSAGE ?></small>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-body">
                            ...
                            <p class="h6 text-muted"><span class="text-dark"><?= $CI->M_pengguna->get_sender($key->SENDER) ?></span> <?= $key->MESSAGE ?><br> <small class="text-muted float-right pull-right mt-2"><?= $CI->time_elapsed($key->CREATED_AT) ?></small> </p>
                            <hr class="mt-5">
