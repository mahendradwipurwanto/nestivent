...
<div class="header-section">
  ...
  <div id="logoAndNav" class="container">
    ...
    <nav class="js-mega-menu navbar navbar-expand-lg">
        ...
        <!-- White Logo -->
        <a class="navbar-brand navbar-brand-default" href="<?= base_url() ?>" aria-label="Nestivent">
          <img src="<?= base_url();?>assets/logo-in.png" alt="Logo">
        </a>
        <!-- End White Logo -->

        <!-- Default Logo -->
        <a class="navbar-brand navbar-brand-collapsed" href="<?= base_url() ?>" aria-label="Nestivent">
          <img src="<?= base_url();?>assets/logo-ts.png" alt="Logo">
        </a>
        <!-- End Default Logo -->

        <!-- On Scroll Logo -->
        <a class="navbar-brand navbar-brand-on-scroll" href="<?= base_url() ?>" aria-label="Nestivent">
          <img src="<?= base_url();?>assets/logo-ts.png" alt="Logo">
        </a>
        <!-- End On Scroll Logo -->
