...
<form action="<?= site_url('manage_kompetisi/'.($cek_form == true ? 'proses_updatePendaftaran' : 'proses_aturPendaftaran'));?>" method="POST">
  ...
  <div class="row">
    ...
    <div class="col-9">
      <div class="card mb-4">
        <div class="card-body">
          <div class="alert alert-<?= $cek_form == true ? 'primary' : 'info';?> mb-0">
            <p class="mb-0"><?= $cek_form == true ? 'Anda telah mengatur formulir pendaftaran! anda dapat merubah formulir pendaftaran jika diperlukan.<br> <b>PERHATIAN!</b> <i>Peserta yang telah mendaftaran, harus melakukan pendaftaran ulang jika dilakukan perubahan formulir pendaftaran!!</i>' : 'Pendaftaran pada kompetisi tidak akan terbuka sebelum anda mengatur form pendaftaran, harap mengatur form pendaftaran sebaik mungkin.';?></p>
          </div>
          <hr>
          <fieldset>
            <legend>Formulir wajib</legend>
            <div class="row mb-0">
              <div class="col-6">
                <div class="form-group">
                  <label class="input-label">Nama</label>
                  <input type="text" class="form-control form-control-flush" readonly>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label class="input-label">Email</label>
                  <input type="email" class="form-control form-control-flush" readonly>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
              ...
              <div class="col-6">
                <div class="form-group mb-0">
                  <label class="input-label">Asal Instansi</label>
                  <input type="text" class="form-control form-control-flush" readonly>
                </div>
              </div>
            </div>
