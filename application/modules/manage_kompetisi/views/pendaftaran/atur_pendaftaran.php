    ...
    <div class="col-sm mb-2 mb-sm-0">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-no-gutter">
          ...
          <li class="breadcrumb-item active" aria-current="page">Berkas Kompetisi</li>
        </ol>
      </nav>

      <h1 class="page-header-title">Atur Berkas Kompetisi</h1>
    </div>
      ...
      <div id="dynamic_field">
                ...
                <div class="card card-body mb-4">
                  <div class="row mb-0">
                    ...
                    <div class="row mt-4 pt-3 border-top">
                      <div class="col-8">
                        <a href="<?= site_url('manage_kompetisi/hapus_formPendaftaran/'.$form->ID_FORM);?>" class="btn btn-light float-right btn-sm btn_remove" onclick=""><i class="tio-delete"></i></a>
                      </div>
                  ...
                  <div class="row mt-4 pt-3 border-top">
                    <div class="col-8">
                      <a href="<?= site_url('manage_kompetisi/hapus_formPendaftaran/'.$form->ID_FORM);?>" class="btn btn-light float-right btn-sm btn_remove" id="<?= $form->ID_FORM;?>"><i class="tio-delete"></i></a>
                    </div>
                    <div class="col-1 border-left">
                ...
                <?php else:?>
                  ...
                  <div class="card card-body mb-4">
                    <div class="row mb-0">
                          ...
                          <?php else:?>
                            <?php foreach ($CI->M_manage->get_formItem($form->ID_FORM) as $item) :?>
                              <div class="row">
                                ...
                                <div class="col-1">
                                  <a href="<?= site_url('manage_kompetisi/hapus_formPendaftaran/'.$form->ID_FORM);?>" class="btn btn-light float-right btn-sm"><i class="tio-delete"></i></a>
                                </div>
                              </div>
                            <?php endforeach;?>
                          <?php endif;?>
                      ...
                      <div class="row mt-4 pt-3 border-top">
                        <div class="col-8">
                          <a href="<?= site_url('manage_kompetisi/hapus_formPendaftaran/'.$form->ID_FORM);?>" class="btn btn-light float-right btn-sm btn_remove"><i class="tio-delete"></i></a>
                        </div>
                        <div class="col-1 border-left">
                          <button type="button" class="btn btn-light btn-sm <?= $form->KETERANGAN != null  || isset($form->KETERANGAN) ? 'text-info' : '';?>" id="btn_ket<?= $form->ID_FORM;?>"><i class="tio-text"></i></button>
                        </div>
        ...
        <div class="col-3">
          <div class="sticky-top">
            ...
            <?php if($cek_form == true):?>
              <a href="<?= site_url('daftar/'.$this->session->userdata('manage_kompetisi'));?>" target="_blank" class="btn btn-sm btn-info btn-block">Lihat formulir</a>
            <?php endif;?>
            <hr>
            <div class="card">
