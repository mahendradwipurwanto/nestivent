			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-no-gutter">
					<li class="breadcrumb-item"><a class="breadcrumb-link"
							href="<?= site_url('manage-kompetisi') ?>">Dashboard</a></li>
...
<div class="card">
	<div class="card-header">
		...
		<button type="button" class="btn btn-xs btn-primary float-right" data-toggle="modal" data-target="#tambah">Tambah
			bidang lomba</button>
									...
									<div class="row">
										<div class="col-6">
											<div class="form-group">
												<label class="input-label font-weight-bold">Nama bidang lomba <small
														class="text-danger">*</small></label>
												<input type="text" class="form-control" name="BIDANG_LOMBA"
													placeholder="Masukkan nama bidang lomba" reqired>
											</div>
										</div>
										<div class="col-6">
											<div class="form-group">
												<label class="input-label font-weight-bold">Tipe upload karya <small
														class="text-danger">*</small></label>
												<select class="js-select2-custom custom-select" size="1" name="TIPE_KARYA"
													data-hs-select2-options='{
          "minimumResultsForSearch": "Infinity"
        }'>
													<option value="1">Dokumen (PDF)</option>
													<option value="2">Gambar (PNG, JPG, JPEG)</option>
													<option value="3">Link Video (Youtube)</option>
												</select>
											</div>
										</div>
									</div>
										...
										<div class="col-4 d-none" id="aturMin">
											<div class="form-group row">
												...
												<div class="js-quantity-counter input-group-quantity-counter">
													<input type="number"
														class="js-result form-control form-control-sm input-group-quantity-counter-control"
														value="1" min="1" max="25" name="MIN_ANGGOTA">
										...
										<div class="col-4 d-none" id="aturMax">
											<div class="form-group row">
												...
												<div class="js-quantity-counter input-group-quantity-counter">
													<input type="number"
														class="js-result form-control form-control-sm input-group-quantity-counter-control"
														value="2" min="2" max="25" name="MAX_ANGGOTA">
									...
									<div class="form-group mb-0">
										<label class="input-label font-weight-bold">Keterangan bidang lomba <small
												class="text-danger">*</small></label>
										<textarea type="text" class="form-control form-control-sm editor" name="KETERANGAN" rows="3"
											placeholder="Masukkan keterangan bidang lomba" reqired></textarea>
									</div>
		...
		<table id="myTable" class="table table-bordered table-nowrap table-align-middle table-hover" width="100%">
			...
			<tbody>
				...
				<tr>
					<td><?= $no++;?></td>
					<td>
						<button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#edit<?= $no;?>"><i
								class="tio-edit"></i></button>
						<button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#hapus<?= $no;?>"><i
								class="tio-delete"></i></button>
					</td>
					<td><?= $key->BIDANG_LOMBA;?></td>
					<td><?= ($key->TEAM == 1 ? 'YA, anggota '.$key->MIN_ANGGOTA.' s/d '.$key->MAX_ANGGOTA : 'TIDAK');?></td>
					<td>
						<button type="button" class="btn btn-xs btn-soft-secondary" data-toggle="modal"
							data-target="#keterangan<?= $no;?>"><i class="tio-eye"></i> keterangan</button>
					</td>
				</tr>

				<div class="modal fade" id="keterangan<?= $no;?>" tabindex="-1" role="dialog"
							...
							<div class="modal-body">
												...
												<div class="col-6">
													<div class="form-group">
														<label class="input-label font-weight-bold">Nama bidang lomba <small
																class="text-danger">*</small></label>
														<input type="text" class="form-control" name="BIDANG_LOMBA"
															value="<?= $key->BIDANG_LOMBA;?>" reqired>
													</div>
												</div>
												<div class="col-6">
													<div class="form-group">
                              ...
                              "minimumResultsForSearch": "Infinity"
															...
															<optgroup label="Current">
																<option value="<?= $key->TIPE_KARYA;?>">
																	<?php switch ($key->TIPE_KARYA) {
                                      case 1:
                                        echo "Dokumen (PDF)";
                                        break;

                                      case 2:
                                        echo "Gambar (PNG, JPG, JPEG)";
                                        break;
                                      case 3:
                                        echo "Link Video (Youtube)";
                                        break;
                                      ...
                                      default:
                                        ...
                                        break;
											...
											<div class="form-group">
												<label class="input-label font-weight-bold">Nama bidang lomba <small
														class="text-danger">*</small></label>
												<input type="text" class="form-control form-control-sm" name="BIDANG_LOMBA"
													value="<?= $key->BIDANG_LOMBA;?>" reqired>
											</div>
											<div class="row">
												<div class="col-4">
													<div class="form-group">
														...
														<label class="toggle-switch d-flex align-items-center mb-3" for="TEAM<?= $no;?>">
															<input type="checkbox" class="toggle-switch-input" name="TEAM" id="TEAM<?= $no;?>"
																<?= ($key->TEAM == 1 ? 'checked' : '');?>>
															<span class="toggle-switch-label">
																<span class="toggle-switch-indicator"></span>
															</span>
												...
												<div class="col-4 <?= ($key->TEAM == 1 ? '' : 'd-none');?>" id="aturMin<?= $no;?>">
													<div class="form-group row">
														...
														<div class="js-quantity-counter input-group-quantity-counter">
															<input type="number"
																class="js-result form-control form-control-sm input-group-quantity-counter-control"
																value="<?= ($key->TEAM == 1 ? $key->MIN_ANGGOTA : 1);?>" min="1" max="25"
																name="MIN_ANGGOTA">
												...
												<div class="col-4 <?= ($key->TEAM == 1 ? '' : 'd-none');?>" id="aturMax<?= $no;?>">
													<div class="form-group row">
														...
														<div class="js-quantity-counter input-group-quantity-counter">
															<input type="number"
																class="js-result form-control form-control-sm input-group-quantity-counter-control"
																value="<?= ($key->TEAM == 1 ? $key->MAX_ANGGOTA : 2);?>" min="2" max="25"
																name="MAX_ANGGOTA">
											...
											<div class="form-group mb-0">
												<label class="input-label font-weight-bold">Keterangan bidang lomba <small
														class="text-danger">*</small></label>
												<textarea type="text" class="form-control form-control-sm editor" name="KETERANGAN" rows="3"
													reqired><?= $key->KETERANGAN;?></textarea>
											</div>
				...
				<div class="modal fade" id="hapus<?= $no;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
					aria-hidden="true">
