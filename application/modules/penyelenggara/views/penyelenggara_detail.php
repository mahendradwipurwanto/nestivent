	...
	<div class="row align-items-lg-center">
		...
		<div class="col-lg-auto">
			<a class="btn btn-sm btn-ghost-secondary"
				href="https://api.whatsapp.com/send?text=Hai, cek informasi penyelenggara <?= ucwords(strtolower($penyelenggara->NAMA)) ?> kami, lebih detail di <?php echo base_url(uri_string()); ?>"
				target="_blank">
...
<div class="container space-bottom-2">
	<div class="row">
		<div id="stickyBlockStartPoint" class="col-md-5 col-lg-4 mb-7 mb-md-0">
			<div class="js-sticky-block card card-bordered p-4" data-hs-sticky-block-options='{
      ...
      "stickyOffsetBottom": 12
				...
				<div class="text-center">
					...
					<img class="img-fluid rounded-circle mx-auto"
						src="<?= ($penyelenggara->LOGO == null ? base_url().'assets/frontend/img/100x100/img12.jpg' : base_url().'berkas/penyelenggara/'.$penyelenggara->KODE_PENYELENGGARA.'/'.$penyelenggara->LOGO);?>"
						alt="Image Description" width="120" height="120">

					<span class="d-block text-body font-size-1 mt-3">Joined from
						<?= date("d F Y", strtotime($penyelenggara->MAKE_DATE));?></span>

					<div class="mt-3">
						<?php if ($CI->M_penyelenggara->cek_hakPenyelenggara($penyelenggara->KODE_PENYELENGGARA) == TRUE) : ?>
						<a class="btn btn-sm btn-outline-primary transition-3d-hover" target="_blank"
							href="<?= site_url('k-panel/'.$penyelenggara->KODE_PENYELENGGARA);?>">
				...
				<div class="border-top pt-4 mt-4">
					<div class="row">
						...
						<div class="col-6 col-md-12 col-lg-6">
							...
							<div class="d-flex">
								<span class="avatar avatar-xs mr-3">
									<img class="avatar-img" src="<?= base_url();?>assets/frontend/svg/illustrations/add-file.svg"
						...
						<div class="col-6 col-md-12 col-lg-6 mb-4 col-6 col-md-12 mb-lg-0">
							...
							<div class="d-flex">
								<span class="avatar avatar-xs mr-3">
									<img class="avatar-img" src="<?= base_url();?>assets/frontend/svg/illustrations/medal.svg"
										alt="Image Description">
								</span>
				...
				<div class="border-top pt-4 mt-4">
					<h1 class="h4 mb-4">Sosial Media</h1>
					...
					<div class="row">
						...
						<div class="col-6 col-md-12 col-lg-6 mb-4">
							<!-- Social Profiles -->
							<a class="media" href="<?= prep_url($penyelenggara->INSTAGRAM);?>" target="_blank">
						...
						<div class="col-6 col-md-12 col-lg-6 mb-0 mb-md-4 mb-lg-0">
							<!-- Social Profiles -->
							<a class="media" href="<?= prep_url($penyelenggara->TWITTER);?>" target="_blank">
								<div class="icon icon-xs icon-soft-secondary mr-3">
						...
						<div class="col-6 col-md-12 col-lg-6">
							<!-- Social Profiles -->
							<a class="media" href="<?= prep_url($penyelenggara->FACEBOOK);?>" target="_blank">
								<div class="icon icon-xs icon-soft-secondary mr-3">
						...
						<div class="col-6 col-md-12 col-lg-6 mb-4">
							<!-- Social Profiles -->
							<a class="media" href="<?= prep_url($penyelenggara->GITHUB);?>" target="_blank">
								<div class="icon icon-xs icon-soft-secondary mr-3">
									<i class="fab fa-youtube"></i>
								</div>
								<div class="media-body">
									<span class="d-block font-size-1 font-weight-bold">Youtube</span>
								</div>
							</a>
							<!-- End Social Profiles -->
						</div>
				...
				<div class="border-top text-center pt-4 mt-4">
					...
					<a class="btn btn-ghost-secondary btn-sm btn-pill small" data-toggle="modal"
						data-target="#suspendPenyelenggara<?= $penyelenggara->KODE_PENYELENGGARA;?>">
						<i class="far fa-flag mr-1"></i> Suspend penyelenggara
					</a>
					<?php else: ?>
					<a class="btn btn-ghost-secondary btn-sm btn-pill small" data-toggle="modal"
						data-target="#laporPenyelenggara<?= $penyelenggara->KODE_PENYELENGGARA;?>">
		...
		<div class="col-md-7 col-lg-8">
			<div class="ml-lg-6">
					...
					<div class="row mx-n2 mx-lg-n3">
						...
						<article class="col-sm-6 col-lg-4 px-2 px-lg-3 mb-3">
							<a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover"
								href="<?= site_url('event/'.$key->KODE_EVENT);?>"
								style="background-image: url(<?= base_url();?>assets/frontend/img/400x500/img13.jpg);">
								<div class="card-body">
									<span
										class="d-block small text-white-70 font-weight-bold text-cap mb-2"><?= ($key->JENIS == 0 ? 'SEMINAR / WEBINAR' : ($key->JENIS == 1 ? 'KULIAH TAMU' : 'WORKSHOP'));?></span>
									<h3 class="text-white"><?= $key->JUDUL;?></h3>
									<span
										class="badge badge-info"><?= $key->STATUS_EVENT == 0 ? 'belum dibuka' : ($key->STATUS_EVENT == 1 ? 'berlangsung' : 'berakhir');?></span>
								</div>
							...
							<div class="card-body p-0">
								<div class="row">
									<div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
										<img class="img-fluid rounded" src="<?= base_url();?>assets/frontend/svg/components/graphics-4.svg"
											alt="Image Description">
									</div>
											...
											<div class="col-lg-6 mb-2 mb-lg-0">
												...
												<div class="d-flex align-items-center flex-wrap">
													<span class="d-inline-block">
														<span
															class="text-dark font-size-1 mr-1"><?= substr(strip_tags($key->DESKRIPSI), 0, 50);?></span>
													</span>
												</div>
											</div>
												...
												<div class="row">
													<div class="col-7">
														<div class="small text-muted mb-2">
															...
															<?= $CI->M_penyelenggara->count_BidangLomba($key->KODE_KOMPETISI) != false ? $CI->M_penyelenggara->count_BidangLomba($key->KODE_KOMPETISI) : 0;?>
															bidang lomba
														</div>
													...
													<div class="col-5 text-right">
														<span
															class="h2 badge badge-<?= $key->STATUS_KOMPETISI == 0 ? 'secondary' : ($key->STATUS_KOMPETISI == 1 ? 'success' : 'primary');?> text-white mb-0"><?= $key->STATUS_KOMPETISI == 0 ? 'belum dibuka' : ($key->STATUS_KOMPETISI == 1 ? 'berlangsung' : 'berakhir');?></span>
													</div>
												</div>
											</div>
										</div>
				...
				<!-- terima Modal -->
				<div class="modal fade bd-example-modal-sm" id="suspendPenyelenggara<?= $penyelenggara->KODE_PENYELENGGARA;?>"
				...
				<!-- terima Modal -->
				<div class="modal fade bd-example-modal-sm" id="kirimPesan" tabindex="-1" role="dialog"
				...
				<!-- terima Modal -->
				<div class="modal fade bd-example-modal-sm" id="laporPenyelenggara<?= $penyelenggara->KODE_PENYELENGGARA;?>"
					tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
					<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
