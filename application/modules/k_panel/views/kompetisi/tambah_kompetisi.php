		...
		<div class="col-sm mb-2 mb-sm-0">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb breadcrumb-no-gutter">
					...
					<li class="breadcrumb-item active" aria-current="page">Buat kompetisi</li>
				</ol>
			</nav>

			<h1 class="page-header-title">Buat kompetisi</h1>
		</div>
...
<form action="<?= site_url('k_panel/proses_buatKompetisi') ?>" method="post" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h5 class="card-header-title">Data Kompetisi</h5>
				</div>
				<div class="card-body">
						<div class="row">
							<div class="col-9">
								...
								<div class="row">
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="MEDIA" class="form-control form-control-sm" placeholder="Media / Tempat kompetisi" required>
										</div>
									</div>
								</div>
								<div class="row">
							...
							<div class="col-3">
								<!-- End Form Group -->
								<button type="submit" class="btn btn-sm btn-primary btn-block">Buat Kompetisi</button>
								<hr>
								<div class="form-group">
