    ...
    <div class="col-sm">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-no-gutter">
          ...
          <li class="breadcrumb-item active" aria-current="page">Notifikasi Penyelenggara</li>
        </ol>
      </nav>

      <h1 class="page-header-title">Notifikasi Penyelenggara</h1>
    </div>
  </div>
  <!-- End Row -->
</div>
    ...
    <div class="alert alert-soft-dark mb-5 mb-lg-7" role="alert">
      <div class="media align-items-center">
        ...
        <div class="media-body">
          <h3 class="alert-heading mb-1">Notifikasi terbaru pada Penyelenggara!</h3>
          <p class="mb-0">Notifikasi terbaru yang terekam pada Penyelenggara.</p>
        </div>
      </div>
    </div>
    <!-- End Alert -->
