<!-- Hero Section -->
<div class="container space-top-1 mt-5" style="background: url(<?= base_url();?>assets/frontend/svg/components/abstract-shapes-9.svg) center no-repeat;">
	<div class="row justify-content-lg-between align-items-lg-center">
		<div class="col-sm-10 col-lg-5 mb-7 mb-lg-0">
			<img class="img-fluid" src="<?= base_url();?>assets/frontend/svg/illustrations/reading.svg"
...
<!-- Articles Section -->
<div class="container space-2" style="background: url(<?= base_url();?>assets/frontend/svg/components/abstract-shapes-19.svg) center no-repeat;">
	<!-- Title -->
	...
	<div class="row justify-content-lg-center align-items-lg-center">
		...
		<div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
			<!-- Card -->
			<a class="card card-bg-light h-100 shadow-sm border overflow-hidden transition-3d-hover"
				href="<?= site_url('event');?>">
		...
		<div class="col-md-6 col-lg-4">
			<!-- Card -->
			<a class="card card-bg-light h-100 shadow-sm border overflow-hidden transition-3d-hover"
				href="<?= site_url('kompetisi');?>">
				<div class="row align-items-center">
					<div class="col-8 col-md-6">
						<div class="py-3 pl-4">
							<h2 class="h4">Kompetisi</h2>
							<span class="font-size-1 font-weight-bold">cari kompetisi <i
...
<div class="space-bottom-2 space-bottom-lg-3"
	style="background: url(<?= base_url();?>assets/frontend/svg/components/abstract-shapes-9.svg) center no-repeat;">
	<div class="position-relative">
		<div class="container space-2">
			...
			<div
				class="js-slick-carousel slick slick-equal-height slick-gutters-3 slick-center-mode-right slick-center-mode-right-offset"
...
"slidesToShow": 1
				...
				<article class="js-slide pt-2">
					<a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover"
						...
						style="background-image: url(<?= base_url();?>assets/frontend/img/400x500/img<?= $key->kegiatan == "kegiatan" ? '13' : '14';?>.jpg);">
						<div class="card-body">
							<span
								class="d-block small text-white-70 font-weight-bold text-cap mb-2"><?= date("d F Y", strtotime($key->TANGGAL));?></span>
...
<!-- Features Section -->
<div class="container space-2 space-lg-3" style="background: url(<?= base_url();?>assets/frontend/svg/components/abstract-shapes-19.svg) center no-repeat;">
	<!-- Title -->
