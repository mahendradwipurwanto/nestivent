...
<div class="container space-top-3 space-top-lg-4">
  <div class="row justify-content-lg-between mb-7">
    <div class="col-md-6 col-lg-5">
      <!-- Info -->
      <div class="mb-5">
        <h1 class="mb-0"><b class="">Kelola semua kegiatan</b> </h1><h2>secara <i>online</i></h2>
      ...
      <div class="col-lg-7 order-lg-1 align-self-lg-end">
        ...
        <div class="tab-content pr-lg-4">
          <div class="tab-pane fade show active" id="pills-one-code-features" role="tabpanel" aria-labelledby="pills-one-code-features-tab">
            <!-- Device Mockup -->
            <div class="device">
              <img class="img-fluid" src="<?= base_url();?>assets/frontend/svg/components/macbook.svg" alt="Image Description">
              <img class="device-macbook-screen" src="<?= base_url();?>assets/frontend/img/1618x1010/img5.jpg" alt="Image Description">
            </div>
            <!-- End Device Mockup -->
          </div>
          ...
          <div class="tab-pane fade" id="pills-two-code-features" role="tabpanel" aria-labelledby="pills-two-code-features-tab">
            <div class="shadow-sm rounded">
              <img class="img-fluid rounded-lg" src="<?= base_url();?>assets/frontend/img/1618x1010/img3.jpg" alt="Image Description">
            </div>
          </div>
          ...
          <div class="tab-pane fade" id="pills-three-code-features" role="tabpanel" aria-labelledby="pills-three-code-features-tab">
            ...
            <div class="device-wrapper">
              <div class="device">
                <img class="img-fluid" src="<?= base_url();?>assets/frontend/svg/components/macbook.svg" alt="Image Description">
                <img class="device-macbook-screen" src="<?= base_url();?>assets/frontend/img/1618x1010/img4.jpg" alt="Image Description">
              </div>
              <div class="device device-iphone-x">
                <img class="device-iphone-x-frame" src="<?= base_url();?>assets/frontend/svg/components/iphone-x.svg" alt="Image Description">
                <img class="device-iphone-x-screen" src="<?= base_url();?>assets/frontend/img/407x867/img7.jpg" alt="Image Description">
              </div>
            </div>
            <!-- End Device Mockup -->
          </div>
